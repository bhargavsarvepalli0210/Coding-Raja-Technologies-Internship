        ...
        if os.path.exists(filename):
            with open(filename, 'r') as file:
                for line in file:
                    ...
                    due_date = dt.datetime.strptime(due_date, "%Y-%m-%d").date() if due_date else None
...
def start():
    ...
    while True:
        ...
        if choice == '1':
            ...
            due_date = dt.datetime.strptime(due_date_str, "%Y-%m-%d").date() if due_date_str else None
